...
sys.path.append("..")
os.chdir('C:\\Users\\kondal reddy\\Dropbox\\My PC (DESKTOP-SB9US3O)\\Downloads\\Major Project\\__pycache__')
from object_detection.utils import label_map_util
from object_detection.utils import visualization_utils as vis_util
os.chdir('C:\\Users\\kondal reddy\\Dropbox\\My PC (DESKTOP-SB9US3O)\\Downloads\\Major Project')
...
with detection_graph.as_default():
    ...
    with tf.io.gfile.GFile(PATH_TO_CKPT, mode = 'rb') as fid:
